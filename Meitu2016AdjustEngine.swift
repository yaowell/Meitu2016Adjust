...
"""
    ...
    func process(
        ...
        if abs(contrast) > 0.001 || sharpness > 0.001 {
            ...
            if sharpness > 0.001 {
                // 使用字符串 "CISharpenLuminance" 进行正确的 CIFilter 初始化
