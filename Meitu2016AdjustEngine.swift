...
final class Meitu2016AdjustEngine {
    ...
    private static let lutCompressed: Data = Data(base64Encoded: """
...
l1132233PfbYc6+99t5nn099+tP77rf//p/57Gf/7oADDzzo4EM+97nPH3rY4Yd/4YuTvvSlI4486uhjjv3cccdf8KJX/n7k776Dyd/7ZSvn/qPp51+xlmT
...
""")!
    ...
    private func applyLUT(
        ...
        guard offset >= 0,
              offset + 255 < Self.lut.count else {
            return
        }
